...
impl NameCollision {
    pub fn value_bind(span: Loc, other: Loc, help: &'static str) -> Self {
        NameCollision::ValueBind { span, other, help }
    }
    pub fn module_bind(span: Loc, other: Loc, help: &'static str) -> Self {
        NameCollision::ModuleBind { span, other, help }
    }
    pub fn type_bind(span: Loc, other: Loc, help: &'static str) -> Self {
